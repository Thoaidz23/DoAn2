...
const handleLogout = () => {
  ...
  if (user.role === 1) {
    menuItems = [
      ...
      { label: "Kho hàng", icon: <FileText size={18} />, path: "/admin/stockwarning-page" },
      ...
      { label: "Phiếu điều chỉnh", icon: <FileText size={18} />, path: "/admin/stockadjust-list" },
    ...
    menuItems = [
      { label: "Đơn hàng", icon: <Receipt size={18} />, path: "/admin/order" },
      { label: "Phiếu nhập", icon: <FileText size={18} />, path: "/admin/import-page" },
      { label: "Lịch sử nhập xuất", icon: <FileText size={18} />, path: "/admin/history-page" },
      { label: "Kho hàng", icon: <FileText size={18} />, path: "/admin/stockwarning-page" },
      { label: "Điều chỉnh số lượng", icon: <FileText size={18} />, path: "/admin/stockadjust-list" },
    ];
  }else {
    menuItems = [
      { label: "Thống kê", icon: <BarChart2 size={18} />, path: "/admin/dashboard" },
...
return (
  ...
  {/* Logout cố định */}
  <div className="flex-shrink-0 p-2 border-top border-secondary">
    <button
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-box-arrow-right" viewBox="0 0 16 16">
        <path fillRule="evenodd" d="M10 12.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0 0 1h2.5v8H10.5a.5.5 0 0 0-.5.5z"/>
        <path fillRule="evenodd" d="M4.854 11.354a.5.5 0 0 0 0-.708L2.707 8.5H10a.5.5 0 0 0 0-1H2.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708 0z"/>
      </svg>
      <span>Đăng xuất</span>
    </button>
  </div>
