  ...
  const renderInput = (label, name, show, toggle) => {
    ...
    return (
      <div className="mb-4">
        ...
        {fieldErrors[name] && (
          <div className="mt-2 ms-1" style={{ fontSize: "0.875rem", color: "white" }}>
  {fieldErrors[name]}
</div>
...
return (
  <div className="account-overview-container bg-dark min-vh-100 py-5">
    <div className="container">
      <div className="account-content p-4 bg-secondary rounded-4 " style={{background:"white",height:"80%",margin:"5% 0 0 13%",color:"black"}}>
