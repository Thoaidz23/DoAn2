...
function MenuBar() {
  ...
  <div className="hover-panel">
    <div className="hover-column">
      ...
      <ul>
        {brandsByCategory[category.name_category_product]?.map((brand, index) => (
          <li
